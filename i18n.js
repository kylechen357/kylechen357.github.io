(function () {
  ...
  const STATIC_TEXT_MAP = {
    ...
    zh: {
      ...
      "Master Research and Graduate Mentor": "碩士研究與研究生指導",
      ...
      "Certification of Complete": "完訓證明",
      "Certification": "證照",
      ...
      "Incoming Equipment Engineer - ETC": "設備工程師（ETC）",
      ...
      "Young College Elite of 2023": "2023 青年學院菁英",
      "Getting Started with AI on Jetson Nano": "Jetson Nano AI 入門",
      "Building Video AI Applications at the Edge": "邊緣端影片 AI 應用開發",
    ...
    ko: {
      ...
      "Master Research and Graduate Mentor": "석사 연구 및 대학원 멘토링",
      ...
      "Outstanding Graduate Award": "우수 졸업상",
      "Young College Elite of 2023": "2023 청년대학 엘리트",
      "Getting Started with AI on Jetson Nano": "Jetson Nano AI 입문",
      "Building Video AI Applications at the Edge": "엣지 환경 비디오 AI 애플리케이션 개발",
    ...
    th: {
      ...
      "Master Research and Graduate Mentor": "วิจัยระดับปริญญาโทและพี่เลี้ยงบัณฑิตศึกษา",
      ...
      "Outstanding Graduate Award": "รางวัลบัณฑิตดีเด่น",
      "Young College Elite of 2023": "เยาวชนดีเด่นประจำปี 2023",
      "Getting Started with AI on Jetson Nano": "เริ่มต้น AI บน Jetson Nano",
      "Building Video AI Applications at the Edge": "พัฒนาแอปพลิเคชันวิดีโอ AI บน Edge",
  ...
  const DICT = {
    ...
    th: {
      ...
      "index.quote": "จงกล้าที่จะทำทุกอย่าง ไม่เช่นนั้นความฝันจะไม่เกิดขึ้น ผมจะพยายามอย่างดีที่สุดเพื่อไปให้ไกลกว่าเดิม",
