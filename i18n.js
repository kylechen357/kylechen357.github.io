(function () {
  ...
  const STATIC_TEXT_MAP = {
    ...
    th: {
      ...
      "Equipment Engineer": "วิศวกรอุปกรณ์",
  ...
  const DICT = {
    en: {
      ...
      "index.tsmc.position": "Equipment Engineer",
      ...
      "index.intro.body": "My name is Kyle, and I am a researcher focused on Visual SLAM, robotic manipulation, explainable AI systems, and digital IC design. I currently work in the semiconductor industry as an equipment engineer.",
      ...
      "research.filter.master": "Master Research",
      "research.filter.competition": "Competition",
      "research.filter.internship": "Internship",
      "research.filter.assistant": "Research Assistant",
      "research.empty.title": "Research Assistant",
      "research.empty.body": "Coming soon...",
      "research.pubs": "Publications",
      "research.journal": "Journal",
      "research.conference": "Conference",
      "research.status.in_progress": "In Progress",
      "research.status.accept": "Accept",
      "research.status.accepted": "Accepted",
      "research.status.published": "Published",
      "research.status.preprint": "Pre-print",
      "research.publication.empty": "No publications in this filter yet.",
      ...
      "work.tsmc.date": "Apr 2026 - Present",
    ...
    zh: {
      ...
      "index.intro.body": "我是嵊凱，研究重點為 Visual SLAM、機器人操作、可解釋 AI 系統與數位 IC 設計，目前在半導體產業擔任設備工程師。",
      ...
      "about.eyebrow": "關於",
      "about.title": "關於我",
      "about.lead": "我叫陳嵊凱，畢業於元智大學電機工程碩士班。在求學期間，我積極參與研究專案、課外活動與學生組織，這些經歷讓我同時培養了技術專業與扎實的軟實力。除了學術背景之外，我也對機器人、人工智慧、電腦視覺與智慧系統充滿熱情。我喜歡探索新想法、跨領域學習，並將知識應用於實際問題。透過研究、團隊合作與領導經驗，我不僅學習到專業技能，也持續提升溝通、協作與解決問題的能力，並成為我持續成長的重要基礎。",
      "about.edu": "學歷",
      ...
      "research.filter.competition": "\u7af6\u8cfd",
      "research.filter.internship": "\u5be6\u7fd2",
      "research.filter.assistant": "\u7814\u7a76\u52a9\u7406",
      "research.empty.title": "\u7814\u7a76\u52a9\u7406",
      "research.empty.body": "\u656c\u8acb\u671f\u5f85...",
      "research.pubs": "論文發表",
      "research.journal": "期刊",
      "research.conference": "研討會",
      "research.status.in_progress": "進行中",
      "research.status.accept": "接受",
      "research.status.accepted": "已接受",
      "research.status.published": "已發表",
      "research.status.preprint": "預印本",
    ...
    ko: {
      ...
      "index.intro.body": "저는 진승개이며 Visual SLAM, 로봇 매니퓰레이션, 설명 가능한 AI 시스템, 디지털 IC 설계를 연구합니다. 현재 반도체 산업에서 장비 엔지니어로 일하고 있습니다.",
      ...
      "research.filter.competition": "\ub300\ud68c",
      "research.filter.internship": "\uc778\ud134\uc2ed",
      "research.filter.assistant": "\uc5f0\uad6c \uc870\uad50",
      "research.empty.title": "\uc5f0\uad6c \uc870\uad50",
      "research.empty.body": "\uacf5\uac1c \uc608\uc815...",
      "research.pubs": "출판물",
      "research.journal": "저널",
      "research.conference": "학회",
      "research.status.in_progress": "진행 중",
      "research.status.accept": "수락",
      "research.status.accepted": "게재 확정",
      "research.status.published": "출판됨",
      "research.status.preprint": "프리프린트",
    ...
    th: {
      ...
      "index.tsmc.position": "วิศวกรอุปกรณ์",
      "index.tsmc.company": "TSMC",
      "index.tsmc.division": "ETC",
      ...
      "index.present": "ปัจจุบัน",
      "index.past": "อดีต",
      "index.intro.title": "สำรวจแนวคิดใหม่และประยุกต์ใช้จริง",
      "index.intro.body": "ผมชื่อ เฉิน เซิงไค โดยมุ่งเน้นงานวิจัยด้าน Visual SLAM, หุ่นยนต์, Explainable AI และ Digital IC Design ปัจจุบันผมทำงานในอุตสาหกรรมเซมิคอนดักเตอร์ในตำแหน่งวิศวกรอุปกรณ์",
      ...
      "about.lead": "ผมชื่อ เฉิน เซิงไค และสำเร็จการศึกษาระดับปริญญาโทด้านวิศวกรรมไฟฟ้าจาก Yuan Ze University ระหว่างการศึกษา ผมมีส่วนร่วมอย่างแข็งขันในโครงการวิจัย กิจกรรมนอกหลักสูตร และองค์กรนักศึกษา ประสบการณ์เหล่านี้ทำให้ผมได้พัฒนาทั้งความเชี่ยวชาญด้านเทคนิคและทักษะด้านการทำงานร่วมกับผู้อื่นอย่างเข้มแข็ง นอกเหนือจากพื้นฐานทางวิชาการ ผมมีความหลงใหลในหุ่นยนต์ ปัญญาประดิษฐ์ คอมพิวเตอร์วิทัศน์ และระบบอัจฉริยะ ผมชอบสำรวจแนวคิดใหม่ ๆ เรียนรู้ข้ามสาขา และนำความรู้ไปประยุกต์ใช้กับปัญหาเชิงปฏิบัติ ผ่านประสบการณ์ด้านการวิจัย การทำงานเป็นทีม และภาวะผู้นำ ผมไม่ได้เรียนรู้เพียงทักษะทางเทคนิคจากการศึกษาเท่านั้น แต่ยังได้พัฒนาทักษะด้านการสื่อสาร การทำงานร่วมกัน และการแก้ปัญหา ซึ่งยังคงหล่อหลอมการเติบโตของผมอย่างต่อเนื่อง",
      "about.edu": "การศึกษา",
      ...
      "research.filter.competition": "\u0e01\u0e32\u0e23\u0e41\u0e02\u0e48\u0e07\u0e02\u0e31\u0e19",
      "research.filter.internship": "\u0e1d\u0e36\u0e01\u0e07\u0e32\u0e19",
      "research.filter.assistant": "\u0e1c\u0e39\u0e49\u0e0a\u0e48\u0e27\u0e22\u0e27\u0e34\u0e08\u0e31\u0e22",
      "research.empty.title": "\u0e1c\u0e39\u0e49\u0e0a\u0e48\u0e27\u0e22\u0e27\u0e34\u0e08\u0e31\u0e22",
      "research.empty.body": "\u0e40\u0e15\u0e23\u0e35\u0e22\u0e21\u0e1e\u0e1a\u0e01\u0e31\u0e19\u0e40\u0e23\u0e47\u0e27 \u0e46 \u0e19\u0e35\u0e49...",
      "research.pubs": "ผลงานตีพิมพ์",
      "research.journal": "วารสาร",
      "research.conference": "ประชุมวิชาการ",
      "research.status.in_progress": "อยู่ระหว่างดำเนินการ",
      "research.status.accept": "ตอบรับ",
      "research.status.accepted": "ตอบรับแล้ว",
      "research.status.published": "ตีพิมพ์แล้ว",
      "research.status.preprint": "พรีปรินต์",
